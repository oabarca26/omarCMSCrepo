...
public class Graph_STUDENT_Test {
	...
	public void setUp() throws Exception {
		 graph = new Graph();
		  ...
		  graph.addEdge(town[2], town[4], 5, "Road_3");
		  graph.addEdge(town[3], town[5], 7, "Road_4");
		  graph.addEdge(town[3], town[2], 9, "Road_5");
	}
	...
	public void testGetEdge() {
		assertEquals(new Road(town[2], town[4],6, "Road_3"), graph.getEdge(town[2], town[4]));
	}

	@Test
	public void testAddEdge() {
		assertEquals(false, graph.containsEdge(town[4], town[5]));
		graph.addEdge(town[4], town[5], 2, "Road_6");
